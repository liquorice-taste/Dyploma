package com.carys.dyploma.voiceService.device;
...
public class DeviceRegister {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(com.hetal.googleassistantsdkdemo.device.DeviceRegister.class);
